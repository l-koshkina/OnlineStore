...
describe('active params util', () => {
  it('should change type string to type array', () => {
    ...
    expect(result.types).toBeInstanceOf(Array); //проверяем является ли types массивом
  })
  ...
  it('should return all params with right types', () => {
    const result = ActiveParamsUtil.processParams({
      types: 'sukkulenti',
      heightFrom: '1',
      heightTo: '1',
  ...
  it('should unknown param is undefined', () => {
